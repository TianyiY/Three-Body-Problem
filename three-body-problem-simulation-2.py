...
def three_body_problem():
    ...
    positions[0] = numpy.array([-1., 3., 2.]) * 1e11
    positions[1] = numpy.array([6., -5., 4.]) * 1e11
    positions[2] = numpy.array([7., 8., -7.]) * 1e11
    ...
    while start_time < end_time:
        ...
        velocities_euler[0] = velocities[0] + h * acceleration1(positions[0],
                                                                positions[1],
                                                                positions[2])
        velocities_euler[1] = velocities[1] + h * acceleration2(positions[1],
                                                                positions[0],
                                                                positions[2])
        velocities_euler[2] = velocities[2] + h * acceleration3(positions[2],
                                                                positions[0],
                                                                positions[1])
